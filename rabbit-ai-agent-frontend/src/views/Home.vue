  ...
  <div class="home-container">
    <div class="header">
      <div class="glitch-wrapper">
        <h1 class="glitch-title">阿符AI超级智能体</h1>
      </div>
...
// 设置页面标题和元数据
useHead({
  title: '阿符AI超级智能体应用平台 - 首页',
  meta: [
    {
      name: 'description',
      content: '阿符AI超级智能体应用平台提供AI恋爱大师和AI超级智能体服务，满足您的各种AI对话需求'
    },
    {
      name: 'keywords',
      content: 'AI智能体,AI应用,AI恋爱大师,AI助手,智能对话,阿符,AI超级智能体,首页'
    }
  ]
})
