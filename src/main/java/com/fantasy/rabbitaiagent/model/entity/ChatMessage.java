package com.fantasy.rabbitaiagent.model.entity;
...
import com.fantasy.rabbitaiagent.model.enums.MessageTypeEnum;
import lombok.Data;
...
public class ChatMessage implements Serializable {
    ...
    /**
     * 将 Spring AI 的 Message 对象转换为数据库实体
     */
    ...
    /**
     * 将数据库实体转换为 Spring AI 的 Message 对象
     */
